# -*- coding: utf-8 -*-
"""
Created on Mon Dec 28 12:55:57 2023

@author: Taslima Akter Sathe
"""
import numpy as np
...
plt.plot(dates, adjusted_close,color ="blue",label = "Adjusted close" )
plt.xlabel('Day')
plt.ylabel('Adjusted Close')
plt.title('Adjusted Close for Every Day in 2008')
plt.legend()
# Now over-plot this plot with a 'red dot' marker for every day where the volume was greater than 5.5 billion.
plt.scatter(mask_index,adjusted_close[mask_index],color= "red", label= "Volume over 5.5 billions")
plt.legend()
plt.show()
